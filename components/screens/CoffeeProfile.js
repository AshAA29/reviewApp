...
class coffeeprofile extends Component {
  ...
  logout = async () => {
      ...
      .then((response) => {
        ...
        {
          this.props.navigation.navigate('CoffeeLogin', { screen: 'CoffeeInitialNav' });
        }
  ...
  render() {
    ...
    return (
      ...
      <View style={styles.container}>
        ...
        <View>
        <Text style={styles.items}>First name: {this.state.profileData.first_name}</Text>
        <Text style={styles.items}>Last name: {this.state.profileData.last_name}</Text>
        <Text style={styles.items}>Email: {this.state.profileData.email}</Text>
        <TouchableOpacity
