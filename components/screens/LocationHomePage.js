    ...
    return (
      <View style={styles.container}>
        <View style={styles.locations}>
          ...
          <View style={styles.stars}>
            <TouchableOpacity onPress={() => this.favLoc()}>
        ...
        <View>
          <TouchableOpacity
            onPress={() =>
              this.props.navigation.navigate("LocationReviewMaker", {
                locID: locID,
              })
            }
          >
        ...
        <View>
          ...
          <Text style={styles.btn}>
            {" "}
            Reviews for {this.state.locationData.location_name}
          </Text>
        </View>
