...
class locationReviewMaker extends Component {
  ...
  postReview = async () => {
    ...
    return fetch(
      "http://10.0.2.2:3333/api/1.0.0/location/" + locID + "/review",
      {
        method: "POST",
        headers: {
      ...
      <View style={styles.container}>
        ...
        <ScrollView>
          <TextInput
            ...
            onChangeText={this.handleOverallRating}
            value={this.state.overall_rating}
          />
          <TextInput
            style={styles.items}
            placeholder="Enter Price Rating..."
            onChangeText={this.handlePriceRating}
            value={this.state.price_rating}
          />
          <TextInput
            style={styles.items}
            placeholder="Enter Quality Rating..."
            onChangeText={this.handleQualityRating}
            value={this.state.quality_rating}
          />
          <TextInput
            style={styles.items}
            placeholder="Enter Clenliness Rating..."
            onChangeText={this.handleClenlinessRating}
